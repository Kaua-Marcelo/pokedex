...
function inicializarFavoritos() {
  ...
  cards.forEach(card => {
    ...
    // Verifica se já está favoritado ao carregar os cards
    ...
    botaoEstrela.addEventListener('click', function () {
      ...
      if (botaoEstrela.style.color === 'gold') {
        ...
        favoritos.push({ id, nome, imagem, tipo, cor: coresCards[tipo] || '#ffffff' });
      }
...
// Roda automaticamente quando está na página de favoritos
